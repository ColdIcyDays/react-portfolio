...
export function ProjectCategoryImageScrollContainer({ someCategoryData, aProjectCategorySubpageName } : { someCategoryData: ProjectData[], aProjectCategorySubpageName : string }) {
   ...
   /* window.addEventListener("wheel", (e) => {
    ...
    return (
        <div  className='w-full xl:pl-12 xl:pr-12 px-0'>
            <div ref={horizontalBar} className='reg-30-div ring-clr-10-1/50 bg-clr-invisible xl:p-12 py-12 pl-2 max-h-full min-h-[512px] xl:min-h-[404px] flex flex-row overflow-x-auto overflow-y-hidden w-full min-w-0 xl:max-w-full max-w-dvw'>
                <ul className='flex gap-12 last:gap-5 xl:last:gap-12'>
